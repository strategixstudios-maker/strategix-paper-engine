...
## Κανόνες κώδικα
- Μόνο με το engine (lib.js, stratos.js, hands.js, props.js, render.js). Νέα reusable props → props.js. Νέος τύπος χεριού → hands.js σε ΟΛΕΣ τις όψεις + `node hands.js sheet`.
...
Σενάριο (Χρόνος | Εικόνα | VO | Κείμενο/SFX) → έγκριση → κώδικας → `sheet` (safe zones + lint) → `lint` καθαρό → `render` MP4 + timing sheet VO/SFX → episode log στο STYLE_GUIDE §8 → `ship.sh`.
- Silent MP4 1080×1920 30fps· VO, SFX, μουσική τα κάνει ο Αλέξανδρος.
