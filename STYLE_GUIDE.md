...
- **«Πώς φτιάχνεται;» #N** — η διαδικασία βήμα-βήμα (laser κ.λπ.) με τον Στράτο, CTA «Στείλε μήνυμα».
- Ιδέες σε αναμονή: «Μύθος ή αλήθεια;», «Το λάθος των 500€», «Κέντημα vs DTF vs Μεταξοτυπία», «POV: είσαι ο plotter».

## 8. Επεισόδια & backlog
- Log επεισοδίων → **`EPISODES.md`** (δεν φορτώνεται αυτόματα· άνοιξέ το για αρίθμηση σειράς / προηγούμενα επεισόδια). Χρονισμοί VO → `<ep>_timing_sheet.md`.
