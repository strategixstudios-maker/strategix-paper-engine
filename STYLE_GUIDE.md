...
### AD — «Θολή αφίσα» online εκτύπωση αφίσας (21,7s) · `ad_afisa.js`
...
| Χρόνος | VO |
|---|---|
| 0,23–3,19 | Περίμενες μια εβδομάδα την αφίσα σου... και βγήκε θολή. |
| 3,72–5,05 | [sighs] Γνωστό σενάριο. |
| 5,26–6,04 | Εκτός αν... |
| 6,28–8,11 | ...την ανεβάσεις εδώ, από το κινητό σου. |
| 8,28–11,78 | Διαλέγεις μέγεθος, και βλέπεις αν η ανάλυση φτάνει. Πριν πληρώσεις. |
| 11,96–14,30 | Premium ματ χαρτί, διακόσια πενήντα γραμμάρια. |
| 14,47–16,33 | Έρχεται σε σωλήνα. Χωρίς τσακίσεις. |
| 16,57–21,12 | Αφίσα από δεκατρία ευρώ. Ανέβασε τη φωτογραφία σου στο strategixstudios.com. |
