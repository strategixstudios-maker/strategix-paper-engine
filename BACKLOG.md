...
- [pf03] Πρώτη μεταξοτυπία → όλα τα screenprint props μέσα στο επεισόδιο (matBG cutting mat, teeFlat, frame/screen states mesh|emulsion|film|stencil|inked, squeegee (≠ `squeegee` του pm01 = ράκλα βινυλίου → άλλο όνομα στο props/), filmPositive, platen heat-press, spray). Στη 2η μεταξοτυπία → `props/screenprint.js` (+ `node api.js --check`).
