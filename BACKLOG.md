...
- [ms01] Πόζες Στράτου με keyframes (`poseAt`: blend γωνιών 0,28s, χέρια/hints αλλάζουν στη μέση) + κάμερα με keyframes πάνω στο `o.cam` → στη 2η χρήση σε `stratos.js` / `props/studio.js` (`poseAt(POSES, t)`, `camPath([[t, cam], ...], t)`).
